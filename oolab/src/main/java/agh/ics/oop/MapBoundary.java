...
public class MapBoundary implements IPositionChangeObserver{
    SortedSet<Vector2d> xSet = new TreeSet<Vector2d>(Comparator.comparing( (Vector2d el1) -> el1.x));
    SortedSet<Vector2d> ySet = new TreeSet<Vector2d>(Comparator.comparing( (Vector2d el1) -> el1.y));
